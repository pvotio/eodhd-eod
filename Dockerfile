...
# System deps + MS ODBC 18 (Debian 12 / Bookworm) using signed keyring
RUN apt-get update && apt-get install -y --no-install-recommends \
 ...
 # expose sqlcmd/bcp without touching shell rc files
...
# Non-root user (same as your original) + ownership
